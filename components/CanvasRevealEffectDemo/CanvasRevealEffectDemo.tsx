...
export function CanvasRevealEffectDemo() {
  return (
    <>
      <div className="pb-20 pt-10 flex flex-col lg:flex-row items-center justify-between bg-black dark:bg-black w-[80%] sm:max-w-[80rem] gap-8 mx-auto">
        <Card title="Research->" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={5.1}
            containerClassName="bg-emerald-900"
          />
        </Card>
        <Card title="Design->" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Implementation" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={3}
...
const AceternityIcon = () => {
  return (
    <img className="h-12 rounded-full" src="/images/logo.jpg" alt="" />
  );
};
