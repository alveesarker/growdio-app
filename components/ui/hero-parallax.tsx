...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[2400px] md:h-[2600px] pt-40 mt-20 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
