    ...
    >
      ...
      >
        <motion.div
          ...
          className={cn("h-full px-4 py-6 sm:px-10", className)}
        >
          <Noise />
          {children}
        </motion.div>
...
const Noise = () => {
  return (
    <div
      className="absolute inset-0 w-full h-full scale-[1.2] transform opacity-10 [mask-image:radial-gradient(rgb(72, 72, 72),transparent,75%)]"
      style={{
