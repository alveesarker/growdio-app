        ...
        <div className="mt-40 flex flex-col items-center justify-center max-w-[80rem] w-[80%] relative left-[50%] translate-x-[-50%] gap-20">
            <div className="pl-4 pr-4">
                ...
                <p className="text-neutral-400 max-w-lg mx-auto my-2 text-sm text-center relative z-10">
                    Welcome to Growdio, the leading digital creative agency. We provide
                    reliable, scalable, and customizable creative solutions for your
                    brand, ensuring that your message resonates and drives results.
                </p>
            </div>
